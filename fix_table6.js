                    ...
                    <div className="p-6">
                      ...
                      <div className="w-full overflow-x-auto no-scrollbar">
                        <div className="min-w-[1100px] border border-white/[0.05] rounded-[2rem] bg-white/[0.02] backdrop-blur-xl overflow-hidden shadow-2xl">
                          ...
                          {/* Cabeçalho da Tabela */}
                          <div className="grid grid-cols-[3rem_1.2fr_1.2fr_1fr_1fr_1fr_1fr_1fr_1fr_120px] gap-4 px-6 py-4 bg-white/[0.02] border-b border-white/[0.05] items-center">
                            ...
                            <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest text-center">Avariada</span>
                            <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest text-center">Rejeitado</span>
                          ...
                          <div className="flex flex-col">
                            {lote.items.map((item, idx) => (
                              <motion.div 
                                ...
                                key={item.id} 
                                className={cn(
                                  "grid grid-cols-[3rem_1.2fr_1.2fr_1fr_1fr_1fr_1fr_1fr_1fr_120px] gap-4 px-6 py-4 items-center group/row hover:bg-white/[0.02] transition-colors border-b border-white/[0.02] last:border-0 relative"
                                )}
                              >
                                {/* 1. Índice */}
...
if (t !== -1 && e !== -1) {
  ...
  console.log("Replaced inner AnimatePresence to be pure columns successfully!");
} else {
