                    ...
                    <div className="px-6 py-4">
                      ...
                      <div className="w-full overflow-x-auto no-scrollbar">
                        <div className="min-w-[1100px] bg-transparent">
                          ...
                          {/* Cabeçalho da Tabela */}
                          <div className="grid grid-cols-[3rem_0.8fr_24px_0.8fr_80px_24px_1fr_0.6fr_24px_0.8fr_0.8fr_0.8fr_140px] gap-4 px-4 py-3 border-b border-white/[0.05] items-center">
                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Nº</span>
                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest text-right">A501 / G501</span>
                            <span></span>
                            ...
                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest text-right">Enviado</span>
                            <span></span>
                          ...
                          <div className="flex flex-col">
                            {lote.items.map((item, idx) => (
                              <motion.div 
                                ...
                                key={item.id} 
                                className="grid grid-cols-[3rem_0.8fr_24px_0.8fr_80px_24px_1fr_0.6fr_24px_0.8fr_0.8fr_0.8fr_140px] gap-4 px-4 py-4 items-center group/row hover:bg-white/[0.01] transition-colors border-b border-white/[0.03] last:border-0 relative"
                              >
                                {/* 1. Índice */}
                                ...
                                {/* 3. Arrows for Estornos */}
                                <div className="flex flex-col gap-2 justify-center items-center py-1">
                                  <ArrowRight size={14} className="text-slate-600" strokeWidth={2.5} />
                                  <ArrowRight size={14} className="text-slate-600" strokeWidth={2.5} />
                                </div>
                                ...
                                {/* 12. Status & Actions */}
                                <div className="flex items-center justify-between pr-2 min-h-[32px]">
                                  <div className={cn(
                                    "flex items-center gap-1.5 text-[11px] font-semibold tracking-wide shrink-0",
                                  ...
                                  {user && (
                                    <button 
                                      ...
                                      className="opacity-0 group-hover/row:opacity-100 transition-all p-1.5 rounded-lg bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 text-blue-400 ml-2"
                                    >
                                      <RefreshCw size={12} />
                                    </button>
                                  )}
...
if (t !== -1 && e !== -1) {
  ...
  console.log("Updated to fix arrow proximity and status button overlap!");
} else {
