                    ...
                    <div className="px-6 py-4">
                      ...
                      <div className="w-full overflow-x-auto no-scrollbar">
                        <div className="min-w-[1100px] bg-transparent">
                          ...
                          {/* Cabeçalho da Tabela */}
                          <div className="grid grid-cols-[3rem_0.8fr_24px_0.8fr_0.6fr_24px_1fr_0.6fr_24px_0.8fr_0.8fr_0.8fr_120px] gap-4 px-4 py-3 border-b border-white/[0.05] items-center">
                          ...
                          <div className="flex flex-col">
                            {lote.items.map((item, idx) => (
                              <motion.div 
                                ...
                                key={item.id} 
                                className="grid grid-cols-[3rem_0.8fr_24px_0.8fr_0.6fr_24px_1fr_0.6fr_24px_0.8fr_0.8fr_0.8fr_120px] gap-4 px-4 py-4 items-center group/row hover:bg-white/[0.01] transition-colors border-b border-white/[0.03] last:border-0 relative"
                              >
                                {/* 1. Índice */}
...
if (t !== -1 && e !== -1) {
  ...
  console.log("Updated to adjust arrow proximity for dates!");
} else {
