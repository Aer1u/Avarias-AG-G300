            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {groupedData.map((lote) => (
                ...
                >
                  ...
                  <div className="relative h-64 flex items-center justify-center p-10 bg-[#0F172A] overflow-hidden border-b border-white/5">
                  ...
                  <div className="p-8 pt-6 flex flex-col flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-5 mb-8 mt-auto">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-[10px] font-black text-blue-500/30 uppercase font-mono">{formatPallets(lote.totalEnviado, lote.grade, true)}</span>
                        </div>
                      </div>
                      <div className="space-y-1">
                        <span className="text-[9px] font-black text-emerald-500 uppercase tracking-widest block">Retrabalhado</span>
                        <div className="flex items-baseline gap-2">
                          <span className="text-base font-black text-emerald-400 font-mono">{lote.totalRetornado}</span>
                          <span className="text-[10px] font-black text-emerald-500/30 uppercase font-mono">{formatPallets(lote.totalRetornado, lote.grade, true)}</span>
                        </div>
                      </div>
                      <div className="space-y-1">
                        <span className="text-[9px] font-black text-rose-500 uppercase tracking-widest block">Rejeitado</span>
                        <div className="flex items-baseline gap-2">
                          <span className="text-base font-black text-rose-400 font-mono">{lote.totalRejeitado}</span>
                          <span className="text-[10px] font-black text-rose-500/30 uppercase font-mono">{formatPallets(lote.totalRejeitado, lote.grade, true)}</span>
                        </div>
                      </div>
                      <div className="space-y-1 col-span-2 pt-2 border-t border-white/5">
                        <span className="text-[9px] font-black text-amber-500 uppercase tracking-widest block">Emb. Avariadas</span>
                        <div className="flex items-baseline gap-1.5">
                          <span className="text-base font-black text-amber-400 font-mono">{lote.totalAvarias}</span>
                          <span className="text-[9px] font-black text-amber-500/30 uppercase">emb</span>
                        </div>
                      </div>
                    </div>
