...
.content-grid{display:grid;grid-template-columns:1fr 240px;gap:12px;margin-bottom:14px}
                                ...
                                <React.Fragment key={nf}>
                                  ...
                                  {nfItems.map((item) => (
                                    <tr key={item.id} style={{ background: "#fafbff" }}>
                                      ...
                                      <td style={{ color: "#64748b", fontSize: "6.5pt", maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{baseCodigos[item.Produto] || "—"}</td>
                                      <td colSpan={4} />
