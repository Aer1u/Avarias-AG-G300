      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 w-full">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button 
            ...
            className={cn(
              "p-2 rounded-xl border transition-all no-print",
              showAnalytics 
                ? "bg-blue-600/10 border-blue-500/20 text-blue-500" 
                : "bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-400"
            )}
            title={showAnalytics ? "Esconder Analytics" : "Mostrar Analytics"}
          >
        ...
        <AnimatePresence mode="wait">
          {showAnalytics && (
            <motion.div 
              ...
              className="flex-none bg-white/50 dark:bg-slate-900/30 backdrop-blur-sm rounded-2xl p-6 border-none flex flex-col gap-8 overflow-y-auto custom-scrollbar relative"
            >
          ...
          {/* Main Distribution - Simplified Section */}
          ...
          <tbody className="border-none">
            {loading ? (
              ...
              filteredDays.map((day, idx) => {
                ...
                const totalOutras = totalEntrada - totalMolhada;
                  ...
                  <React.Fragment key={dateStr}>
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5 text-center">
                        <span className={cn(
                          "font-bold font-mono text-sm",
                          hasItems ? "text-slate-500 dark:text-slate-500" : "text-slate-400"
                        )}>
                          {hasItems ? totalOutras : "—"}
                        </span>
                      </td>
                      <td className="px-5 py-3.5 text-center">
                        {totalMolhada > 0 ? (
                          <div className="inline-flex items-center justify-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-transparent">
                                  ...
                                  <table className="w-full text-left">
                                    <thead className="bg-slate-50 dark:bg-slate-800/50 sticky top-0 z-10 border-none">
                                      <tr>
                                        ...
                                        <th className="px-5 py-3 text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-widest w-[80px]">Outras Av</th>
                                      ...
                                      {(() => {
                                        ...
                                        return Object.entries(groupedByNF).map(([nf, nfItems]) => {
                                          ...
                                          const isNFExpanded = expandedNFs[`${dateStr}-${nf}`];
                                           ...
                                           const totalOutrasNF = totalEntradaNF - totalMolhadaNF;
                                            ...
                                            <React.Fragment key={nf}>
                                              ...
                                              >
                                                ...
                                                <td className="px-5 py-3.5 text-sm font-mono text-slate-500 dark:text-slate-400">
                                                  {isMulti ? totalOutrasNF : (nfItems[0].Entrada || 0) - (nfItems[0]["Quantidade Molhada"] || 0)}
                                                </td>
                                              ...
                                              <AnimatePresence>
                                                {isMulti && isNFExpanded && nfItems.map((item, idx) => (
                                                  ...
                                                  >
                                                    ...
                                                    <td className="px-5 py-2.5 text-sm font-mono text-slate-500 dark:text-slate-400">
                                                      {(item.Entrada || 0) - (item["Quantidade Molhada"] || 0)}
                                                    </td>
