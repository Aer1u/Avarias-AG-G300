...
const sIdx = content.lastIndexOf(startStr);
const eIdx = content.lastIndexOf(endStr) + endStr.length;

if (sIdx !== -1 && eIdx !== -1) {
  let finalContent = content.substring(0, sIdx) + NEW_CONTENT + content.substring(eIdx);
